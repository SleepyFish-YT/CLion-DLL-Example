...
- [Jetbrains CLion 2024.1](https://www.jetbrains.com/clion/)
...
Then go in the settings and add a new `Toolchain > Build, Execution, Deployment` click on the `+` then select 
